  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: AppColors.whiteColor,
        centerTitle: true,
        title: Text(AppLocalizations.of(context)!.signIn,style: AppStyles.blackMed18,),
      ),
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text(AppLocalizations.of(context)!.welcomBack,style: AppStyles.blackBold24,),
                SizedBox(height: 12,),
                Row(children: [
                ...
                Row(
                  ...
                  children: [
                    TextButton(onPressed: (){},
                        child: Text(AppLocalizations.of(context)!.forgetPassword,style: AppStyles.blueBold14,)),
                  ],
                ),
                ...
                Center(child: Column(
                  children: [
                    Text(AppLocalizations.of(context)!.newToAdaptiveComms,style: TextStyle(color: Colors.grey,fontSize: 14),),
                    TextButton(onPressed: (){
                      Navigator.pushNamed(context, AppRoutes.register);
                    },
                        child: Text(AppLocalizations.of(context)!.createAnAccount,style: AppStyles.blueBold14,)),
